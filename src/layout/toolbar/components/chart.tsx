...
function _ChartToolbar() {
  ...
  console.log("Selected= ", selected.chart.options?.elements?.bar?.borderRadius);
      ...
      <Popover>
        ...
        <PopoverContent onOpenAutoFocus={(event) => event.preventDefault()} className="pt-2 pb-3 px-3" align="center">
          ...
          <div className="flex items-center justify-between gap-4">
            <Slider min={2} max={100} value={[selected.chart.options?.elements?.bar?.borderRadius as number]} onValueChange={([radius]) => editor.canvas.chart.changeActiveChartBorderRadius(radius)} />
            <Input
              type="number"
