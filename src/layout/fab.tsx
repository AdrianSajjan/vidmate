...
function _EditorFAB() {
  ...
  return (
    <div className={cn("absolute bottom-6 left-6 flex items-center gap-2.5 z-20", editor.canvas.timeline?.playing ? "pointer-events-none opacity-50" : "pointer-events-auto opacity-100")}>
